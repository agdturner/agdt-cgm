 ...
 */
package uk.ac.leeds.ccg.andyt.projects.cgm.misc;
 ...
 * @author geoagdt
 */
public class DisplayShapefile extends Geotools_Object {

    public DisplayShapefile() {
    }

    public DisplayShapefile(Geotools_Environment ge) {
        super(ge);
    }
...
//        String name = "county_region.shp";
        ...
        name = "PLAN_CYCLE_ROUTES.shp";
        dir = new File(
                "C:/Users/geoagdt/src/projects/agdt-cgm/data/input/");
